      ...
      <Table class="min-w-[900px]">
        ...
        <TableBody class="divide-y divide-border">
          ...
          <TableRow v-for="conn in connections" :key="conn.id" class="hover:bg-muted/30">
            ...
            <TableCell class="min-w-[80px] px-6 py-4 text-xs text-muted-foreground break-words">{{ conn.protocol === 'dujiao-next' ? 'TaoAi' : conn.protocol }}</TableCell>
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <Select v-model="form.protocol">
                ...
                <SelectContent>
                  <SelectItem value="dujiao-next">TaoAi</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
