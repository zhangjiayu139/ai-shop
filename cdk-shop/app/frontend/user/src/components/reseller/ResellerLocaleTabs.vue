...
defineProps<{ modelValue: ResellerLocale; labels?: Record<string, string> }>()
const emit = defineEmits<{ (e: 'update:modelValue', value: ResellerLocale): void }>()

const locales = resellerLocales
</script>
