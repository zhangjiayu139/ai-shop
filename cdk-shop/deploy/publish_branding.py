...
shutil.copy2(root/'build/taoai-brand/taoai-shop',root/'runtime/dujiao-next')
...
print('TaoAi branding image deployed and healthy; all other containers unchanged.')
